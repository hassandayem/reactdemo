...
class MovieDetail extends Component {
  componentDidMount() {
    ...
    dispatch(fetchTheSimilarMovies(this.props.params.id));
  }
  ...
  componentWillReceiveProps(nextProps) {
    ...
    if (nextProps.params.id && this.props.params.id !== nextProps.params.id) {
      ...
      dispatch(fetchTheSimilarMovies(nextProps.params.id));
    }
  }
      ...
      return (
        <Grid fluid={false}>
          ...
          <Row>
            ...
            <MovieList
              movies={similarMovies.results.slice(0, SIMILAR_MAX_NUM)}
              similar={true}
            />
          </Row>
        </Grid>
